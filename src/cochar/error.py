...
class IncorrectOccupation(CocharError):
    ...
    def __init__(self, occupation_name: str) -> None:
...
class CharacteristicValueNotAnInt(CocharError):
    ...
    def __init__(self, skill_name: str, skill_value: Any) -> None:
...
class CharacteristicPointsBelowMinValue(CocharError):
    ...
    def __init__(self, skill_name: str, min_value=0) -> None:
        self.skill_name = skill_name
...
class InvalidSexValue(CocharError):
    ...
    def __init__(self, sex: str | None, available_sex: set[str | None]) -> None:
        self.sex = sex
...
class InvalidAgeValue(CocharError):
    ...
    def __init__(self, age: Any) -> None:
        self.age = age
...
class InvalidCountryValue(CocharError):
    ...
    def __init__(self, country: str, available_countries: set) -> None:
...
class InvalidOccupationValue(CocharError):
    ...
    def __init__(self, occupation: str, available_occupations: list[str]) -> None:
...
class InvalidDamageBonusValue(CocharError):
    ...
    def __init__(self, damage_bonus: str, correct_damage_bonus: list[str]) -> None:
...
class InvalidBuildValue(CocharError):
    ...
    def __init__(self, build: int, correct_build: list[int]) -> None:
        self.build = build
...
class InvalidOccupationEra(CocharError):
    ...
    def __init__(self, era: str, correct_era: set[str]) -> None:
        self.era = era
...
class InvalidOccupationType(CocharError):
    ...
    def __init__(self, _type: str, correct_type: list[str]) -> None:
        self._type = _type
...
class InvalidOccupationTags(CocharError):
    ...
    def __init__(self, tags: str, correct_tags: list[str]) -> None:
        self.tags = tags
